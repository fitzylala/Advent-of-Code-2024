...
public class Day2 {
    ...
    public static boolean isGood(ArrayList<Integer> myList) {
        ArrayList<Integer> temp = (ArrayList<Integer>) myList.clone();
        Collections.sort(temp);
        ArrayList<Integer> ascending = (ArrayList<Integer>) temp.clone();

        boolean safe = true;
        for (int i=1; i<myList.size(); i++) {
            int now = myList.get(i);
            int prev = myList.get(i-1);
            int difference;
            if (prev > now) {
                difference = prev-now;
            } else { difference = now-prev; }
        ...
        if (safe && (myList.equals(ascending) || myList.equals(ascending.reversed()))) {
            return true;
        } else { return false; }
    }
    ...
    public static void main(String[] args) {
        ...
        for (String report: reports) {
            ...
            String[] preLevels = report.split("\\s+");
            ArrayList<Integer> levels = new ArrayList<Integer>();
            for (String s : preLevels) {
            ...
            if (!(isGood(levels))) {
                ...
                for (int i=0; i < levels.size(); i++) {
                    ArrayList<Integer> missing = (ArrayList<Integer>) levels.clone();
                    missing.remove(i);
                    //System.out.println(missing + " checking... " + isGood(missing));
                    if(isGood(missing)){
                        possibleFixes++;
                    }
                }
        ...
        System.out.println(part2counter+part1counter);
